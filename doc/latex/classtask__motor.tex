...
\-Definition at line 94 of file task\-\_\-motor.\-cpp.
...
\-This method is called once by the \-R\-T\-O\-S scheduler. \-Each time around the for (;;) loop, it reads the \-A/\-D converter and change the selected motors speed. \-Each loop checks if it is being controled by a pot or by a given value and reacts accordingly 

\-Definition at line 61 of file task\-\_\-motor.\-cpp.



\-References adc\-\_\-select, brake, motor\-\_\-driver\-::brake(), brake\-\_\-pin, count, driver, pot, adc\-::read\-\_\-once(), and runs.
